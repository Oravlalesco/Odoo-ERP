...
| Operational Block | Bloqueo lógico por dimensiones (`wms.inventory.block`). Persistencia/RBAC (INV-002), Matching API (INV-003), Availability Guard (INV-004); Allocation/Reservation diferido. | 🆕 Crear WMS |
